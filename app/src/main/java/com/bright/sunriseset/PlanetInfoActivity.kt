...
import com.bright.sunriseset.Utils.LocaleUtils
...
Log.d("coxx",Locale.getDefault().language)
        ...
        GlobalScope.launch(Dispatchers.Main) {
            ...
            if (sunriseTime != null && sunsetTime != null) {
                ...
                binding.textViewSunrise.text =  
                    "${LocaleUtils.getLocalizedString(context,R.string.SunriseTime)} $localizedSunrise"
                binding.textViewSunset.text =
                    "${LocaleUtils.getLocalizedString(context,R.string.SunsetTime)} $localizedSunset"
            }
        }
    }
